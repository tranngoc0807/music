        ...
        <div className="container">
          <div className="title">
            ...
            <h4 style={{ padding: "30px 30px" }}>
              Nếu bạn đã mua đúng giấy phép beat và bạn nhận được khiếu nại về
              bản quyền trong video của mình. Vui lòng sử dụng mẫu dưới đây để
                ...
                <div className="row">
                  ...
                  <div className="col-12 mb-3  mt-3 ">
                    <label
                      ...
                      className="form-label"
                    >
                      Liên kết của video có bản quyền của bạn
                    </label>
                    <input
                      type="email"
                      className="form-control"
