    ...
    return (
         <div className="wrapper">
              <div className="container">
                  <div className="title">
                         <button type="button" className="btn btn-warning" style={{width:100,marginTop:100,color:'#000'}}>CONTACT</button>
                  ...
                  <div className="body-contact">
                     ...
                     <div className="row">
                        ...
                        <div className="col-12 mb-3  mt-3 custom">
                                ...
                                <input type="email" className="form-control"  placeholder="Adress Email" />
                            </div>
                            ...
                            <div className="col-12 mb-3  mt-3 custom-example" >
                                ...
                                <textarea className="form-control bg-Dark"   placeholder="Your Feedback" rows={3} defaultValue={""} />
                            </div>
                            
                     </div>
                     <div style={{textAlign:'center',padding:'30px 0'}}>
                             <button type="button" className="btn btn-success  mt-3" style={{ width:'300px',height:'70px'}}>SEN TO DONE</button>
                     </div>
                        </div>   
                      </div>
                  </div>
