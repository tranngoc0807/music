    ...
    return (
         <div className="wrapper">
              <div className="container">
                  <div className="title">
                         <h1 style={{fontSize:36,paddingTop:100}}>Dễ dàng nâng cấp giấy phép của bạn lên một cấp mới</h1>
                  ...
                  <div className="body-License">
                     ...
                     <div className="row">
                           <div className="col-6 mb-3 mt-3 cust ">
                                ...
                                <input type="email" className="form-control"  placeholder="ví dụ:loveless" />
                           </div>
                         
                             <div className="col-6 mb-3 mt-3 cust ">
                                <label for="exampleFormControlSelect1">Upgrade Type</label>
                            ...
                            <div className="col-6 mb-3 mt-3 cust ">
                                ...
                                <input type="email" className="form-control"  placeholder="Jone doe "/>
                           </div> 
                           <div className="col-6 mb-3 mt-3 cust ">
                           ...
                           <div className="col-6 mb-3 mt-3 cust  ">
                                <label htmlFor="exampleFormControlInput1" className="form-label">Tên nghệ sĩ / Tên công ty</label>
                                <input type="email" className="form-control"  placeholder="Lil Nas X" />
                           </div>
                            ...
                            <div className="table">
                                  <table>
                                      ...
                                      <tr>
                                          <td>Upgrade Type - Non-profit to Monetization License</td>
                                          <td>$35.00</td>
                                          <td>1</td>
                                          <td>$35.00</td>
                                      </tr>
                            ...
                            <label className="form-check-label">
                                    ...
                                    tôi đã đọc và đồng ý với <a style={{color:'#F4C82A'}}>Các điều khoản và điều kiện</a>Các điều khoản và <a style={{color:'#F4C82A'}}>điều kiện và Chính sách bảo mật</a>
                            </label>
                            </div>
                     ...
                     <div style={{textAlign:'center',padding:'30px 0'}}>
                             <button type="button" className="btn btn-warning  mt-3" style={{ width:'300px',height:'70px',fontSize:20}}>Make a Payment</button>
                     </div>
                        </div>   
